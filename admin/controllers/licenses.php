 ...
 * @since  1.6
 */
class PixextControllerLicenses extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=licenses');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'license', $prefix = 'PixextModel', $config = array())
	{
