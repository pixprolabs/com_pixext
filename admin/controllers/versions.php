 ...
 * @since  1.6
 */
class PixextControllerVersions extends JControllerAdmin
{
	/**
	 * Method to clone existing Versions
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=versions');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'version', $prefix = 'PixextModel', $config = array())
	{
