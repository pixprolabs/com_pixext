 ...
 * @since  1.6
 */
class PixextControllerExtensions extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=extensions');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'extension', $prefix = 'PixextModel', $config = array())
	{
