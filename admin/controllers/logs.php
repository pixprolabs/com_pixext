 ...
 * @since  1.6
 */
class PixextControllerLogs extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=logs');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'log', $prefix = 'PixextModel', $config = array())
	{
