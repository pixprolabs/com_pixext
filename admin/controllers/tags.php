 ...
 * @since  1.6
 */
class PixextControllerTags extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=tags');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'tag', $prefix = 'PixextModel', $config = array())
	{
