 ...
 * @since  1.6
 */
class PixextControllerTypes extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=types');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'type', $prefix = 'PixextModel', $config = array())
	{
