 ...
 * @since  1.6
 */
class PixextControllerPackages extends JControllerAdmin
{
	/**
	 * Method to clone existing Packages
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_pixext&view=packages');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'package', $prefix = 'PixextModel', $config = array())
	{
