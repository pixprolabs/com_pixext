 ...
 * @since  1.6
 */
class PixextModelTags extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('a.pixext_tag_id', 'asc');
	}
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			if (stripos($search, 'pixext_tag_id:') === 0)
			{
				$query->where('a.pixext_tag_id = ' . (int) substr($search, 3));
			}
			else
			{
