...
<form
	action="<?php echo JRoute::_('index.php?option=com_pixext&layout=edit&pixext_tag_id=' . (int) $this->item->pixext_tag_id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="tag-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PIXEXT_TITLE_TAG', true)); ?>
		<div class="row-fluid">
