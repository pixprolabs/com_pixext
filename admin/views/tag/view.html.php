 ...
 * @since  1.6
 */
class PixextViewTag extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$isNew = ($this->item->pixext_tag_id == 0);
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_TAG'), 'tag.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pixext.tag', $this->item->id);
		}
