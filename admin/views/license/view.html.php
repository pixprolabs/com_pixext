 ...
 * @since  1.6
 */
class PixextViewLicense extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$isNew = ($this->item->pixext_license_id == 0);
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_LICENSE'), 'license.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pixext.license', $this->item->pixext_license_id);
		}

		if (empty($this->item->pixext_license_id))
		{
