 ...
 * @since  1.6
 */
class PixextViewPackage extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$isNew = ($this->item->pixext_package_id == 0);
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_PACKAGE'), 'package.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pixext.package', $this->item->pixext_package_id);
		}
