...
class PixextViewExtension extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$isNew = ($this->item->pixext_extension_id == 0);
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_EXTENSION'), 'extension.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pixext.extension', $this->item->pixext_extension_id);
		}

		if (empty($this->item->pixext_extension_id))
		{
