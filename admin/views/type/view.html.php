 ...
 * @since  1.6
 */
class PixextViewType extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$isNew = ($this->item->pixext_type_id == 0);
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_TYPE'), 'type.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pixext.type', $this->item->pixext_type_id);
		}

		if (empty($this->item->pixext_type_id))
		{
