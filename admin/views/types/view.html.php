 ...
 * @since  1.6
 */
class PixextViewTypes extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		PixextHelpersPixext::addSubmenu('types');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_TYPES'), 'types.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_pixext&view=types');
	...
	{
		return array(
			'a.`pixext_type_id`' => JText::_('COM_PIXEXT_TYPES_PIXEXT_TYPE_ID'),
			'a.`type`' => JText::_('COM_PIXEXT_TYPES_TYPE'),
		);
	}
}
