 ...
 * @since  1.6
 */
class PixextViewLogs extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		PixextHelpersPixext::addSubmenu('logs');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PIXEXT_TITLE_LOGS'), 'logs.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_pixext&view=logs');
	...
	{
		return array(
			'a.`pixext_log_id`' => JText::_('COM_PIXEXT_LOGS_PIXEXT_LOG_ID'),
			'a.`pixext_log_type_id`' => JText::_('COM_PIXEXT_LOGS_PIXEXT_LOG_TYPE_ID'),
			'a.`pixext_log_from_id`' => JText::_('COM_PIXEXT_LOGS_PIXEXT_LOG_FROM_ID'),
			'a.`pixext_license_id`' => JText::_('COM_PIXEXT_LOGS_PIXEXT_LICENSE_ID'),
			'a.`when`' => JText::_('COM_PIXEXT_LOGS_WHEN'),
		);
	}
}
